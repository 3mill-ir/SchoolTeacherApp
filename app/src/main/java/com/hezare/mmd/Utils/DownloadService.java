...
public class DownloadService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            mBuilder.setContentTitle("دارووری")
                    .setContentText("در حال دانلود بروزرسانی")
                    .setSmallIcon(R.drawable.ic_file_download_black_24dp)
                    .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.solda_icon));
            //.setAutoCancel(true);
            ...
            OutputStream output = new FileOutputStream(Environment.getExternalStorageDirectory().getPath() + "/daruvery.apk");
